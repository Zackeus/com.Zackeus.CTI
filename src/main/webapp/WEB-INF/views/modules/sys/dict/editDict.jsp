...
<body class="childrenBody">
	...
	<form class="layui-form layui-form-pane">
		<div class="layui-form-item layui-row layui-col-xs12" style="display:none">
			...
			<div class="layui-input-block">
				<input id="id" name="id" type="text" class="layui-input" lay-verify="required" value="${dict.id}">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">字典键值</label>
			<div class="layui-input-block">
				<input id="value" name="value" type="text" class="layui-input" lay-verify="required" placeholder="请输入字典键值" value="${dict.value}">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">字典标签</label>
			<div class="layui-input-block">
				<input id="label" name="label" type="text" class="layui-input" lay-verify="required" placeholder="请输入字典标签" value="${dict.label}">
			</div>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
	...
	<script type="text/javascript" src="${ctxStatic}/js/modules/sys/dict/editDict.js"></script>
</body>
</html>